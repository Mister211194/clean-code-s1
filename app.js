...
const taskInput = document.querySelector(".add-task__input");//Add a new task.
var addButton = document.getElementsByTagName("button")[0];//first button
const incompleteTaskHolder = document.querySelector(".todo-app__list_to-done");
const completedTasksHolder = document.querySelector(".todo-app__list_done");
...
var bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
    ...
    var editButton = taskListItem.querySelector("button.item__btn_edit");
    var deleteButton = taskListItem.querySelector("button.item__btn_delete");
